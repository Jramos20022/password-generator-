...
class passwordAtt{
  ...
  constructor(length, lowers, uppers, numeric, specials){
    this.length = length;
    this.lowers = lowers;
    this.uppers = uppers;
...
function gatherCriteria() {
   ...
   var lower = window.confirm("Include lower case characrters in password?");
   passwordLower = lower; 
   // console.log(passwordLower);

   var upper = window.confirm("Include upper case characrters in password?");
   passwordUpper = upper;

   // console.log(passwordUpper);


   var numeric = window.confirm("Include numeric characrters in password?");
   passwordNumeric = numeric;

   // console.log(passwordNumeric);


   var specials = window.confirm("Include special characrters in password?");
   passwordSpecial = specials;

   // console.log(passwordSpecials);



  if(goodLength){
    if(lower || upper || numeric || specials){
      attributesGood = true;

      // console.log("The attributes are possible. atributesGood =" + attributesGood);
    }
    else {
